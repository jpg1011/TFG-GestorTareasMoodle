...
\newcommand{\nombre}{Javier Pampliega García} %%% cambio de comando

% Datos de portada
\title{PlanLMS \\ 
        Aplicación multiplataforma para la gestión de tareas de la plataforma Moodle}
\author{\nombre}
...
\noindent Que el alumno D. \nombre, con DNI 71755086P, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado PlanLMS Aplicación multiplataforma para la gestión de tareas de la plataforma Moodle. 
